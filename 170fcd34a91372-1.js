...
<body>
          ...
          <div class="cf-column">
            ...
            <p>
              <form action="/cdn-cgi/phish-bypass" method="GET">
                <input type="hidden" name="atok" value="N4nar.NgO6RxrUGwKdWtMfYBgoJYsrczx39K02PS0xQ-1728772278-0.0.1.1-/get/E14IJTyn/170fcd34a91372-1.js">
  ...
  <p class="text-13">
    <span class="cf-footer-item sm:block sm:mb-1">Cloudflare Ray ID: <strong class="font-semibold">8d1a8a148a566ee7</strong></span>
    <span class="cf-footer-separator sm:hidden">&bull;</span>
    <span id="cf-footer-item-ip" class="cf-footer-item hidden sm:block sm:mb-1">
      Your IP:
      <button type="button" id="cf-footer-ip-reveal" class="cf-footer-ip-reveal-btn">Click to reveal</button>
      <span class="hidden" id="cf-footer-ip">105.113.112.144</span>
      <span class="cf-footer-separator sm:hidden">&bull;</span>
    </span>
